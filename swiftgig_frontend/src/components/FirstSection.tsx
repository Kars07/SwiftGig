    ...
    <section className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden bg-gradient-to-b from-[#0b0013] via-[#1a0025] to-black pt-40">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed animate-fade-in-up animation-delay-200">
          SwiftGig connects Talents and clients through secure escrow Treasury payments, verified reviews, 
          and trustless smart contracts—empowering work that’s fast, fair, and global.
        </p>

        {/* CTA Button */}
        <button
          onClick={onGetStarted}
          className="group inline-flex items-center space-x-2 bg-gradient-to-r from-[#622578] to-[#8b3a9e] 
          hover:from-[#7a2e94] hover:to-[#a347b8] text-white font-semibold px-8 py-4 rounded-xl 
          transition-all duration-300 shadow-2xl shadow-purple-500/50 hover:shadow-purple-500/70 
        ...
        {/* Stats */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20 animate-fade-in-up animation-delay-600 mb-10">
      ...
      <style>{`
        ...
        /* Animation delays (fixed version) */
