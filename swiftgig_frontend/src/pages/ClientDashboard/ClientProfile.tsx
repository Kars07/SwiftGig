    ...
    <div className="min-h-screen bg-[#1A031F]/80 text-white p-6 md:px-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10">
          <div>
            <p className="text-purple-400 text-sm mb-2">Client Dashboard</p>
            <h1 className="text-3xl font-bold mb-2">Profile</h1>
            <p className="text-gray-400">Manage your profile information</p>
          </div>
          <button 
            onClick={() => navigate('/edit-client-profile')}
            className="mt-4 md:mt-0 flex items-center gap-2 bg-purple-500 cursor-pointer px-6 py-3 rounded-lg text-sm font-semibold shadow-lg shadow-purple-500/30 hover:bg-purple-600 transition"
          >
            <Edit3 size={18} />
            Edit Profile
          </button>
        ...
        <div className="bg-[#2B0A2F]/70 backdrop-blur-sm border border-[#641374]/50 rounded-xl p-8 md:p-10 shadow-lg mb-8">
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="flex flex-col items-center lg:items-start">
              ...
              <div className="mt-6 flex gap-3">
                <div className="bg-[#641374]/20 rounded-xl px-4 py-2 text-center">
                  <p className="text-2xl font-bold text-purple-300">{profileData.rating || '5.0'}</p>
                  <p className="text-xs text-gray-300 mt-1">Rating</p>
                </div>
                <div className="bg-[#641374]/20 rounded-xl px-4 py-2 text-center">
                  <p className="text-2xl font-bold text-purple-300">{profileData.gigsCreated || '0'}</p>
                  <p className="text-xs text-gray-300 mt-1">Gigs</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1">
              ...
              <p className="text-xl text-purple-400 font-medium mb-4">Client</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Verification Status */}
          <div className="bg-[#2B0A2F]/70 backdrop-blur-sm border border-[#641374]/50 rounded-xl p-6 shadow-md">
            <h3 className="text-xl font-bold mb-5 flex items-center gap-2">
              <Award className="text-purple-400" size={22} />
              Verification Status
            </h3>
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-[#2B0A2F]/60 rounded-lg border border-[#3A0F3F]">
                <div>
          ...
          <div className="bg-[#2B0A2F]/70 backdrop-blur-sm border border-[#641374]/50 rounded-xl p-6 shadow-md">
            ...
            <div className="space-y-3">
              <div className="p-4 bg-[#2B0A2F]/60 rounded-lg border border-[#3A0F3F]">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="p-4 bg-[#2B0A2F]/60 rounded-lg border border-[#3A0F3F]">
                  ...
                  <p className="text-white font-medium text-purple-300">{profileData.country || 'N/A'}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Account Statistics */}
        <div className="mt-8 bg-[#2B0A2F]/70 backdrop-blur-sm border border-[#641374]/50 rounded-xl p-6 shadow-md">
          <h3 className="text-xl font-bold mb-5 flex items-center gap-2">
            <Star className="text-purple-400" size={22} />
            Account Statistics
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="p-4 bg-[#2B0A2F]/60 rounded-lg border border-[#3A0F3F] text-center">
              <p className="text-3xl font-bold text-purple-300 mb-1">{profileData.gigsCreated || '0'}</p>
              <p className="text-sm text-gray-400">Total Gigs Created</p>
            </div>
            <div className="p-4 bg-[#2B0A2F]/60 rounded-lg border border-[#3A0F3F] text-center">
              <p className="text-3xl font-bold text-purple-300 mb-1">{profileData.activeGigs || '0'}</p>
              <p className="text-sm text-gray-400">Active Gigs</p>
            </div>
            <div className="p-4 bg-[#2B0A2F]/60 rounded-lg border border-[#3A0F3F] text-center">
              <p className="text-3xl font-bold text-purple-300 mb-1">{profileData.completedGigs || '0'}</p>
              <p className="text-sm text-gray-400">Completed Gigs</p>
            </div>
            <div className="p-4 bg-[#2B0A2F]/60 rounded-lg border border-[#3A0F3F] text-center">
              <p className="text-3xl font-bold text-purple-300 mb-1">{profileData.rating || '5.0'}</p>
